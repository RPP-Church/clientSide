export function VisitorIcon(props) {
  return (
    ...
    >
      <path
        fill='currentColor'
        d='M18 18q-.825 0-1.412-.587T16 16t.588-1.412T18 14t1.413.588T20 16t-.587 1.413T18 18m-4 4v-.575q0-1.1 1.1-1.763T18 19t2.9.663t1.1 1.762V22zm3-10h-2V7q0-1.275-.9-2.137T12 4t-2.1.863T9 7v10q0 1.2.9 2.1t2.1.9v2q-2.125 0-3.562-1.437T7 17V7q0-2.125 1.438-3.562T12 2t3.563 1.438T17 7zm-5-2q.825 0 1.413-.587T14 8t-.587-1.412T12 6t-1.412.588T10 8t.588 1.413T12 10m-2 6q0 .825.588 1.413T12 18t1.413-.587T14 16t-.587-1.412T12 14t-1.412.588T10 16m2 1q-.45 0-.725-.312T11 16t.275-.687T12 15t.725.275T13 16q0 .375-.275.688T12 17'
      ></path>
    </svg>
  );
}

export function MemberIcons(props) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function LineMdHome(props) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function HugeiconsArchive(props) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function MingcuteDepartmentLine(props) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function LsiconListFilled(props) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function UilSetting(props) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function MaterialSymbolsContentPasteGo(props) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
